...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='equipment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='equipment_boxs', to='infoMFSS.equipmentinstallation', verbose_name='Подключенное оборудование'),
        ),
    ]
