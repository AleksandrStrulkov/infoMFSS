...
from users.views import LoginView, LogoutView, RegisterView, RegisterDoneView, user_activate, UserUpdateView, \
    PasswordEditView, PasswordEditDoneView, SMSVerificationView
...
urlpatterns = [
        ...
        path(
            'accounts/password-reset/', PasswordResetView.as_view(
        ...
        path(
            'accounts/password-reset/done/', PasswordResetDoneView.as_view(
                    template_name='users/password_reset_done.html'
            ), name='password_reset_done'
            ),
        path(
            'accounts/password-reset/<uidb64>/<token>/', PasswordResetConfirmView.as_view(
        ...
        path(
            'accounts/password-reset/complete/', PasswordResetCompleteView.as_view(
